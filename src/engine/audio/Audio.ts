...
export class Audio{
    ...
    private constructor(){
        ...
        this.loadSound('../../assets/laser.mp3').then((sound)=>{ this._sounds.set(Audio.BOMB,sound) })
        this.loadSound('../../assets/death.mp3').then((sound)=>{ this._sounds.set(Audio.DEATH,sound) })
        this.loadSound('../../assets/explosion.mp3').then((sound)=>{ this._sounds.set(Audio.EXPLOSION,sound) })
        this.loadSound('../../assets/retro-laser.mp3').then((sound)=>{ this._sounds.set(Audio.LASER,sound) })
    }
